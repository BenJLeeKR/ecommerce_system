...
- **인프라 초기 정책 승인 완료**: 백업/복구에 관한 초기 정책 기준은 승인 및 확정되었으며, 실제 복구 절차 수립과 복구 테스트 완료는 전용 DB 생성 후 별도로 대기 중이다.
...
- [ ] 결제 PG 연동 위치 및 흐름 승인
- [x] 공용 PostgreSQL 초기 백업 정책 승인
- [ ] 공용 PostgreSQL 실제 복구 절차 및 복구 테스트 완료 (전용 DB 생성 후 수행 예정)
