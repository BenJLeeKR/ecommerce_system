...
- [WL-0033-2026-09-23-runtime-db-initialization-documentation](WL-0033-2026-09-23-runtime-db-initialization.md) — 외부 상태 디렉터리 생성, 빈 DB 초기화 및 권한 적용을 비민감 범위 내에서 문서에 정합화한 내역 기록.
