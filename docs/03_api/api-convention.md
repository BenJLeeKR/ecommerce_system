...
> 관련 문서: `docs/01_architecture/architecture-overview.md`, `docs/02_domain/domain-model.md`, `docs/04_database/naming-conventions.md`, `docs/04_database/database-design.md`
